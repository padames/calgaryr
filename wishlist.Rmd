...
* Software engineering needed for integrating R in other environment, objective-oriented programming, package development and documentation, debugging, and interfacing with other languages, etc. 
* Advanced techniques in reproducible research, parallel computing, scientific computing, and operational research, etc. 
* Visualization method and communication 
